            ...
            <div className="projects-container">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/new-zealand-police-logo.jpg" alt="New Zealand Police Logo" loading="lazy"/>
                    </picture>
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/mylistings-example-image.jpg" alt="MyListings Example Listing" loading="lazy"/>
                    </picture>
                    <div className="project-text">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/f2p-wiki.jpg" alt="F2P OSRS Wiki Screenshot" loading="lazy"/>
                    </picture>
                    <div className="project-text">
                        <h3>F2P OSRS Wiki</h3>
                        <div className="project-tags">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/iourpg-website.jpg" alt="IOURPG Website Screenshot" loading="lazy"/>
                    </picture>
                    <div className="project-text">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/wedding-website.jpg" alt="Wedding Website Screenshot" loading="lazy"/>
                    </picture>
                    <div className="project-text">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/iou-helper.jpg" alt="IOU Helper Screenshot" loading="lazy"/>
                    </picture>
                    <div className="project-text">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/iou-helper-2.jpg" alt="IOU Helper 2.0 Screenshot" loading="lazy"/>
                    </picture>
                    <div className="project-text">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/iou-bot.jpg" alt="IOU Discord Bot Screenshot" loading="lazy"/>
                    </picture>
                    <div className="project-text">
                        <h3>IOU Bot</h3>
                        <div className="project-tags">
                ...
                <div className="project">
                    <picture className="project-image">
                        ...
                        <img src="img/jpg/random-food-picker.jpg" alt="Random Food Picker Screenshot" loading="lazy"/>
                    </picture>
                    <div className="project-text">
